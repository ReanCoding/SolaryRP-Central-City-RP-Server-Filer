...
function Holograms()
		...
		if GetDistanceBetweenCoords( -112.19700622559,-610.60046386719,36.280727386475, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			...
			Draw3DText( -112.19700622559,-610.60046386719,36.280727386475  -1.600, "SolaryRP!", 4, 0.07, 0.07)
			Draw3DText( -112.19700622559,-610.60046386719,36.280727386475  -1.800, "Discord -  https://discord.gg/JfDcGaJ", 4, 0.07, 0.07)		
		end
	end
end
