        ...
        if spawned then
            ...
            if IsControlPressed(0, 207) then
                ...
                if users.ems ~= nil then
                    DrawText3D("HomeTown Network Server #"..servernumber,0.5,0.17,1,255,255,255,255)
                    ...
                    DrawText3D("Psykolog: "..users.psykolog,0.5,0.43,0.8,255,255,255,255)
                    ...
                    DrawText3D("Spillere online: "..users.online.."/32",0.5,onlinetpos,0.8,255,255,255,255)
