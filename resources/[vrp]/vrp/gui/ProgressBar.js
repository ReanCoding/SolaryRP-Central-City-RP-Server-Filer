...
function ProgressBar(data)
{
  ...
  this.div.style.backgroundColor = "rgba(60,60,60,255)";
...
if ($(window).width() >= 1900 ) {
        //set size
        this.div.style.width = this.div_label.style.width = (126)+"px";
        ...
        //set position
        this.div.style.left = (cfg.anchor_minimap_left+anchor_index*134-29)+"px";
        ...
        this.div_inner.style.height = this.div.style.height = this.div_label.style.height = (45)+"px";
        this.div_label.style.lineHeight = this.div_label.style.height;
