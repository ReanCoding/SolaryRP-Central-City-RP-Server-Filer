...
local itemtr_study = {
  ...
  recipes = {
    ...
    ["Matematik bog"] = { -- action name
      description="Læs en matematik bog", -- action description
      in_money=0, -- money taken per unit
      out_money=0, -- money earned per unit
      reagents={}, -- items taken per unit
      products={}, -- items given per unit
...
local itemtr_laboratory = {
  ...
  recipes = {
    ["Cocaine"] = { -- action name
      description="Lav cocaine", -- action description
	...
	["Weed"] = { -- action name
      description="Lav weed", -- action description
      in_money=1000, -- money taken per unit
      out_money=0, -- money earned per unit
      reagents={ -- items taken per unit
	  ["weed"] = 1
...
cfg.slot_types = {
  ...
  ["plantation_flat_3"] = {
    ...
    ["drug_lab2"] = {
     {
     {"entry",1088.6257324218,-3188.1843261718,-38.993469238282},
     {"chest", 1099.85546875,-3193.7399902344,-38.993469238282, _config = {weight=1000}},
	 {"wardrobe",1103.1495361328,-3198.3532714844,-38.993465423584}
    }
  },
  ["drug_lab"] = {
    {
    {"entry",1905.9844970704,3711.9926757812,32.801322937012},
    {"chest", 1900.912475586,3711.0078125,32.772312164306, _config = {weight=500}}
   }
 }
}
...
cfg.homes = {
  ...
  ["Super Lab"] = {
    slot = "drug_lab2",
    entry_point = {1135.1490478516,-789.26141357422,57.60120010376},
    buy_price = 6000000,
    sell_price = 1,
    max = 5,
    blipid=0,
  ...
  ["Mini Lab"] = {
    slot = "drug_lab",
    entry_point = {1907.1895751954,3710.1328125,32.729175567626},
    buy_price = 1500000,
    sell_price = 1,
    max = 50,
    blipid=0,
