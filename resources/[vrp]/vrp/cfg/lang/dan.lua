...
local lang = {
  ...
  cityhall = {
    ...
    identity = {
      ...
      description = "Lav en ny identitet, koster 50 DKK.",
    ...
    menu = {
      title = "Identitet",
      info = "<em>Efternavn: </em>{1}<br /><em>Fornavn: </em>{2}<br /><em>Alder: </em>{3}<br /><em>CPR-NUMMER: </em>{4}<br /><em>Mobilnummer: </em>{5}<br /><em>Adresse: </em>{7} {6}<br /><em>Penge: {8}<br /><em>Bank: {9}<br /><em>ID: {10}"
    }
  },
  police = {
    title = "Politiet",
    ...
    pc = {
      ...
      trackveh = {
        ...
        prompt_reg = "Skriv den nummerplade du ønsker at efterlyse.",
    ...
    menu = {
      ...
      askid = {
        ...
        description = "Spørg om sygesikring",
        request = "Ønsker du at fremvise dit ID?",
        request_hide = "Skjul ID .",
        asked = "Spørger efter ID..."
      },
	   license = {
		title = "Fratag Kørekort",
		description = "Fratag kørekort fra den nærmeste spiller."
	  },
      check = {
      ...
      fine = {
        ...
        notify_fined = "~b~Du modtog en bøde på ~s~ {2} DKK for ~b~{1}.",
      ...
      carsearch = {
        ...
        description = "Indtast nummerpladen og se hvem der ejer køretøjet",
		prompt = "Indtast nummerpladen og se hvem der ejer køretøjet"
      },
      cprsearch = {
        title = "Slå CPR. NR OP",
        description = "Indtast CPR nummer og se hvad der står i kriminalregisteret",
		promt = "Indtast CPR nummer og se hvad der står i kriminalregisteret"
      }
    },
    identity = {
  ...
  home = {
    ...
    friend = {
      title = "Tilføj ven",
      description = "Tilføj en ven til dit lab (Max 1)",
      added = "Din ven er blevet tilføjet",
      no_home = "~r~Du har ikke en adresse her.",
      prompt = "Nummer:",
      prompt_id = "Id på ven:"
    },
